...
const RecetteCBD = () => {
    ...
    useEffect(() => {
        fetch('/src/api/ecrin_bulle.json')
            ...
            .then(data => setData(data.recettecbd));
    }, []);

    const handleCardClick = (id) => {
        navigate(`/content/recettecbd/${id}`);
    };

    return (
        <section className=" min-h-screen bg-[#ede4d5] ">
            <div className="container mx-auto p-4 bg-[#ede4d5] ">
            <h1 className="text-6xl font-bold my-12 text-center Joliet-font">Recette CBD</h1>
